...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/krypttocoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/krypttocoin-cli.cpp \
           src/krypttocoin-tx.cpp \
           src/krypttocoin.cpp \
           src/db.cpp \
           ...
           src/qt/krypttocoin.cpp \
           src/qt/krypttocoinstrings.cpp \
...
RESOURCES += src/qt/krypttocoin.qrc src/qt/krypttocoin_locale.qrc

TRANSLATIONS += src/qt/locale/krypttocoin_bg.ts \
                src/qt/locale/krypttocoin_de.ts \
                src/qt/locale/krypttocoin_en.ts \
                src/qt/locale/krypttocoin_es.ts \
                src/qt/locale/krypttocoin_fi.ts \
                src/qt/locale/krypttocoin_fr.ts \
                src/qt/locale/krypttocoin_it.ts \
                src/qt/locale/krypttocoin_ja.ts \
                src/qt/locale/krypttocoin_pl.ts \
                src/qt/locale/krypttocoin_pt.ts \
                src/qt/locale/krypttocoin_ru.ts \
                src/qt/locale/krypttocoin_sk.ts \
                src/qt/locale/krypttocoin_sv.ts \
                src/qt/locale/krypttocoin_vi.ts \
                src/qt/locale/krypttocoin_zh_CN.ts \
                src/qt/locale/krypttocoin_zh_TW.ts
