...
/** Utility functions used by the krypttocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render krypttocoin addresses in monospace font
...
// Parse "krypttocoin:" URI into recipient object, return true on successful parsing
