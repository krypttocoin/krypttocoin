                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("krypttocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a krypttocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and krypttocoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About krypttocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about krypttocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for krypttocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your krypttocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified krypttocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a krypttocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the krypttocoin Core help message to get a list with possible krypttocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("krypttocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to krypttocoin network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if (masternodeSync.IsBlockchainSynced()) {
        ...
        if (masternodeSync.IsSynced()) {
            ...
            progressBar->setMaximum(2 * MASTERNODE_SYNC_THRESHOLD);
...
{
    QString strTitle = tr("krypttocoin Core"); // default title
