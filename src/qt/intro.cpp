...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("krypttocoin Core"),
     ...
     * override -datadir in the krypttocoin.conf file in the default data directory
     * (to be consistent with krypttocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
