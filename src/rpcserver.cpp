...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop krypttocoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "krypttocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"krypttocoin", "masternode", &masternode, true, true, false},
        {"krypttocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"krypttocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"krypttocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"krypttocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"krypttocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"krypttocoin", "startmasternode", &startmasternode, true, true, false},
        {"krypttocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"krypttocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"krypttocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"krypttocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"krypttocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"krypttocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"krypttocoin", "mnbudget", &mnbudget, true, true, false},
        {"krypttocoin", "preparebudget", &preparebudget, true, true, false},
        {"krypttocoin", "submitbudget", &submitbudget, true, true, false},
        {"krypttocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"krypttocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"krypttocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"krypttocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"krypttocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"krypttocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"krypttocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"krypttocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"krypttocoin", "mnsync", &mnsync, true, true, false},
        {"krypttocoin", "spork", &spork, true, true, false},
        {"krypttocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"krypttocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use krypttocoind, or the -server option to krypttocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> krypttocoin-cli " + methodname + " " + args + "\n";
}
