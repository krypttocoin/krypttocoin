...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("krypttocoin Core krypttocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  krypttocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded krypttocoin transaction") + "\n" +
                               "  krypttocoin-tx [options] -create [commands]   " + _("Create hex-encoded krypttocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded krypttocoin transaction
