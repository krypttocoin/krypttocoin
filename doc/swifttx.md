...
This mechanism has been integrated into Bitcore-Node-krypttocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/krypttocoin-crypto/insight-api-krypttocoin#web-socket-api](https://github.com/krypttocoin-crypto/insight-api-krypttocoin#web-socket-api)
* API: [https://github.com/krypttocoin-crypto/insight-api-krypttocoin#swifttx-transactions](https://github.com/krypttocoin-crypto/insight-api-krypttocoin#swifttx-transactions)
...
By default, the krypttocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the krypttocoin Core daemon:
