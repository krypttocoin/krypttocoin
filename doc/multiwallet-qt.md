...
In order to support loading of multiple wallets in krypttocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is krypttocoin.cpp.
...
Changes to krypttocoin.cpp
----------------------
krypttocoin.cpp is the entry point into krypttocoin-qt, and as such, will require some minor modifications to provide hooks for
