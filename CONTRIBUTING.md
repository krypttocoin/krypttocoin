Contributing to krypttocoin Core
============================

The krypttocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the krypttocoin Core project, and is not to be
confused with overall krypttocoin Network Protocol consensus changes.

Whether a pull request is merged into krypttocoin Core rests with the project merge
...
Patches that change krypttocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the krypttocoin consensus, it must have been
...
The project leader is the release manager for each krypttocoin Core release.
